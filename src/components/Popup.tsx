...
const Popup: React.FC<PopupProps> = ({title, content, buttonText, parentCallback}: PopupProps) => {  
  ...
  const renderContent: () => JSX.Element = () => {
    if (content === 1) {
      ...
      return (
        <div className="work">
          <WorkRow title={"Quiet Thoughts"} description={"Led a team of 5+ people to create, design and publish a game"} buttonText={"To Steam"} href={"https://store.steampowered.com/app/1514620/Quiet_Thoughts/"} src={"banner.png"} hasButton={true}/>
